...
ISPF debug tools
© Copyright IBM Corp. 1980, 2025 317
...
Panel trace command (ISPDPTRC)
318  z/OS: z/OS ISPF Dialog Developer's Guide and Reference
...
Panel trace command (ISPDPTRC)
Appendix C. Diagnostic Tools and Information  319
...
3. The panel trace can be controlled from a REXX exec by adding lines similar to the following at the
appropriate locations in the exec:
...
Panel trace command (ISPDPTRC)
320  z/OS: z/OS ISPF Dialog Developer's Guide and Reference
...
========= ISPF Panel Trace ==================== 2004.243 04:53:20 GMT ==========
    ...
    Options in Effect: PANEL(*) SCREEN(0) SECTION(INIT REINIT PROC)
     ...
     Physical Display: PRI=24x80  ALT=60x132  
...
---- ---- -------- ------- -- ---  ---------------------------------------- … -->
Figure 82. Sample Panel Trace header
...
Panel trace command (ISPDPTRC)
Appendix C. Diagnostic Tools and Information  321
...
Panel display
Figure 83 on page 323 shows the output and input trace generated for panel ISRUTIL. It includes a
...
Panel trace command (ISPDPTRC)
322  z/OS: z/OS ISPF Dialog Developer's Guide and Reference

## Page 351

TLD1 DspO                         0----+----1----+----2----+----3----+----4----+----5----+----6----
+----7----+----8
...
TLD1 DspO ISRUTIL                 +
TLD1 DspO ISRUTIL                 | 1  Library     Compress or print data set.  Print index listing.  
Print,
TLD1 DspO ISRUTIL                 |                  rename, delete, browse, edit or view members
TLD1 DspO ISRUTIL                 | 2  Data Set    Allocate, rename, delete, catalog, uncatalog, or 
display
TLD1 DspO ISRUTIL                 |                  information of an entire data set
TLD1 DspO ISRUTIL                 1 3  Move/Copy   Move, or copy members or data sets
TLD1 DspO ISRUTIL                 | 4  Dslist      Print or display (to process) list of data set 
names.
...
TLD1 DspO ISRUTIL                 | 12 SuperC      Compare data sets                             
(Standard Dialog)
TLD1 DspO ISRUTIL                 | 13 SuperCE     Compare data sets Extended                    
(Extended Dialog)
TLD1 DspO ISRUTIL                 2 14 Search-For  Search data sets for strings of data          
(Standard Dialog)
TLD1 DspO ISRUTIL                 | 15 Search-ForE Search data sets for strings of data Extended 
(Extended Dialog)
TLD1 DspO ISRUTIL                 | 16 Tables      ISPF Table Utility
TLD1 DspO ISRUTIL                 | 17 Udlist      Print or display (to process) z/OS UNIX directory 
list
TLD1 DspO ISRUTIL  --------------- Screen=23x80  Cursor=4/14
TLD1 DspI                         0----+----1----+----2----+----3----+----4----+----5----+----6----
+----7----+----8
...
TLD1 DspI ISRUTIL                 +
TLD1 DspI ISRUTIL                 | 1  Library     Compress or print data set.  Print index listing.  
Print,
TLD1 DspI ISRUTIL                 |                  rename, delete, browse, edit or view members
TLD1 DspI ISRUTIL                 | 2  Data Set    Allocate, rename, delete, catalog, uncatalog, or 
display
TLD1 DspI ISRUTIL                 |                  information of an entire data set
TLD1 DspI ISRUTIL                 1 3  Move/Copy   Move, or copy members or data sets
TLD1 DspI ISRUTIL                 | 4  Dslist      Print or display (to process) list of data set 
names.
...
TLD1 DspI ISRUTIL                 | 12 SuperC      Compare data sets                             
(Standard Dialog)
TLD1 DspI ISRUTIL                 | 13 SuperCE     Compare data sets Extended                    
(Extended Dialog)
TLD1 DspI ISRUTIL                 2 14 Search-For  Search data sets for strings of data          
(Standard Dialog)
TLD1 DspI ISRUTIL                 | 15 Search-ForE Search data sets for strings of data Extended 
(Extended Dialog)
TLD1 DspI ISRUTIL                 | 16 Tables      ISPF Table Utility
TLD1 DspI ISRUTIL                 | 17 Udlist      Print or display (to process) z/OS UNIX directory 
list
TLD1 DspI ISRUTIL  --------------- Screen=23x80  Cursor=4/15  Key=ENTER
Figure 83. Sample DISPLAY trace
Panel processing trace
Figure 84 on page 324 shows an example of the trace generated when processing the PROC section of
...
Panel trace command (ISPDPTRC)
Appendix C. Diagnostic Tools and Information  323
...
Figure 84. Sample PROCESS trace
...
The syntax of the command is:
File tailoring trace command (ISPFTTRC)
324  z/OS: z/OS ISPF Dialog Developer's Guide and Reference
...
present, this data set is viewed. SYSOUT data sets are not supported.
File tailoring trace command (ISPFTTRC)
Appendix C. Diagnostic Tools and Information  325
...
Controls the generation of trace records based on the screen ID.
File tailoring trace command (ISPFTTRC)
326  z/OS: z/OS ISPF Dialog Developer's Guide and Reference
...
terminates without starting to process the trace.
3. The file tailoring trace can be controlled from a REXX exec by adding lines similar to the following at
the appropriate locations in the exec:
• ADDRESS ISPEXEC 'SELECT CMD(ISPFTTRC)'
• ADDRESS ISPEXEC 'SELECT CMD(ISPFTTRC VIEW)'
Trace format
Here are the details of the trace format, for the trace header and the processing trace.
File tailoring trace command (ISPFTTRC)
Appendix C. Diagnostic Tools and Information  327
...
---- ---- -------- ------  -- -- -- --  -- -- ----------------------------- … -->
Figure 85. Sample file  tailoring trace header
The trace header shows the following information:
1. Current date and time (GMT) when the trace was initialized
2. ISPF level information as found in dialog variable ZISPFOS
3. z/OS level information as found in dialog variable ZOS390RL
...
File tailoring trace command (ISPFTTRC)
328  z/OS: z/OS ISPF Dialog Developer's Guide and Reference
...
Indicates a True condition
File tailoring trace command (ISPFTTRC)
Appendix C. Diagnostic Tools and Information  329
...
Figure 86. Sample file  tailoring process trace
Diagnostic information
This section is intended to help you gather information to diagnose ISPF problems.
Diagnostic information
330  z/OS: z/OS ISPF Dialog Developer's Guide and Reference
...
You can display a panel (Figure 87 on page 331) for selecting command options by entering the ENVIRON
...
Figure 87. ENVIRON Settings Panel (ISPENVA)
...
Diagnostic information
Appendix C. Diagnostic Tools and Information  331
...
message
Diagnostic information
332  z/OS: z/OS ISPF Dialog Developer's Guide and Reference
...
Diagnostic information
334  z/OS: z/OS ISPF Dialog Developer's Guide and Reference
...
• Task abend code
Diagnostic information
336  z/OS: z/OS ISPF Dialog Developer's Guide and Reference
...
codes.
On abnormal ISPF termination, the Error Recovery panel shown in Figure 88 on page 337 indicates the
abend code and reason code.
 ...
 Command ===>
      ...
      * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
      * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
Figure 88. Error Recovery Panel (ISPPRS1)
...
Additional Diagnostic Information panel as shown in Figure 89 on page 338.
...
displayed. Figure 89 on page 338 shows sample data where the SDWA extension is installed. The format
...
Figure 89. Additional Diagnostic Information panel (ISPPRS3)
...
Diagnostic information
338  z/OS: z/OS ISPF Dialog Developer's Guide and Reference
...
created using DTL.
Common problems using ISPF
340  z/OS: z/OS ISPF Dialog Developer's Guide and Reference
...
Abend codes and information
342  z/OS: z/OS ISPF Dialog Developer's Guide and Reference
...
ISPWB002
Call to BPX1QSN to send a message to the queue failed. Return code: 'xxxx'X Reason
code: 'xxxx'X
...
from BPX1QSN.
ISPWB003
Call to BPX1QRC to read a message from the queue failed. Return code: 'xxxx'X Reason
code: 'xxxx'X
The ISPF session is abnormally terminated.
...
ISPWB004
Call to BPX1QRC returned a message of length zero. Return code: 'xxxx'X Reason code:
'xxxx'X
The ISPF session is abnormally terminated.
This operator message is issued when a call to z/OS UNIX service BPX1QRC to receive response
...
Invalid input AID.
Terminal I/O error codes
344  z/OS: z/OS ISPF Dialog Developer's Guide and Reference
...
Obtaining message IDs
346  z/OS: z/OS ISPF Dialog Developer's Guide and Reference
...
Obtaining message IDs
348  z/OS: z/OS ISPF Dialog Developer's Guide and Reference
